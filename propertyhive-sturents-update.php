...
class properthive_sturents_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'https://wp-property-hive.com/add-on-store/propertyhive-sturents-v1hsan83z/update-info.php',
...
if( is_admin() )
{
	new properthive_sturents_update();
}
